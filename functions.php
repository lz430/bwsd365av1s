...
function blain_setup() {
	...
	register_nav_menus( array(
        ...
        'secondary' => __( 'Second Top Menu', 'blain' ),
        'mobile-top' => __( 'Mobile top menu', 'blain' ),
        'footer' => __( 'Footer Menu', 'blain' ),
        'companies' => __( 'Companies Menu', 'blain' ),
        'kaufman' => __( 'Kaufman slider Menu', 'blain' ),
	) );
