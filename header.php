 ...
 * Displays all of the <head> section and everything up till <div id="content">
  * @package burnsWilcox BWBrokerage
 */
?>
  <!DOCTYPE html>
        ...
        <div id="top-slider">
          <div class="row container">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <a href="http://www.kaufmanfinancialgroup.com/">
        ...
        <div class="slider-wrapper theme-default">
          ...
          <?php
            wp_nav_menu( array(
              ...
              'depth'             => 2,
              'container'         => 'div',
              'container_class'   => 'sidebar-offcanvas',
              'menu_class'        => 'nav navbar-nav',
              'fallback_cb'       => 'wp_bootstrap_navwalker::fallback',
              'walker'            => new wp_bootstrap_navwalker())
            );
              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <h1 class="site-title logo-container">
                  <a href="<?php echo esc_url( home_url( '/' ) ); ?> " title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                    <?php echo "<img alt='Burns &amp; Wilcox' class='main_logo' src='".of_get_option('logo', true)."' title='".esc_attr(get_bloginfo( 'name','display' ) )."'></a></h1>";  
                    }else {  }?>
              </div>
              <!--end logo column -->
            ...
            <?php
              ...
              for ($i=1;$i<6;$i++) {
                ...
                if ( of_get_option('slide'.$i, true) != "" ) {
                  echo "<a href='".of_get_option('slideurl'.$i, true)."'><img src='".of_get_option('slide'.$i, true)."' title='".$caption."' alt='Slide'></a>"; 
                  $slider_flag = true;
                }
              }
            ?>
      ...
      <div class="site-branding">
        <div class="col-md-4 col-sm-12 col-xs-12">
          ...
          <h1 class="site-title logo-container">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
              <?php 
                echo "<img alt='logo' class='main_logo' src='".of_get_option('logo', true)."' title='".esc_attr(get_bloginfo( 'name','display' ) )."'></a></h1>";  
                }else {  }
              ?>
        </div><!--end logo column -->
        <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
...
<div id="content" class="site-content row <?php if(is_page_template('page-solutions.php') || is_single() || is_archive() || is_home() )echo 'container' ?>">