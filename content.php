...
<article id="post-<?php the_ID(); ?>" <?php post_class("row archive"); ?>>
	...
	<header class="entry-header">
		...
		<h1 class="entry-title h1"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
	...
	<?php if ( of_get_option('excerpt1', true) == 0 ) : ?>
		...
		<?php the_content( __( 'Contine reading <span class="meta-nav">&rarr;</span>', 'burnsWilcox' ) ); ?>
